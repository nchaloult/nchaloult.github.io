...
function ManPage() {
  ...
  return (
    <div>
      ...
      <div className="tabbed">
        <p>
          <b>nick</b> has a passion for learning about new technologies, and loves discovering better ways to do things. <b>nick</b>'s concentrations in school are Intelligence and Info & Internetworks. <b>nick</b> expects to graduate in May of 2021.
        </p>
      </div>
